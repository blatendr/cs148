...
function securityCheck($path_parts, $yourURL, $form = false) {
    ...
    $whiteListPages[] = "main.php";
    $whiteListPages[] = "portfolio.php";
    $whiteListPages[] = "top.php";
    $whiteListPages[] = "loginForm.php";        
    
    //add all the folders to this array
    $whiteListFolders = array();
    $whiteListFolders[] = "/cs148";
    $whiteListFolders[]="/cs148develop";
    $whiteListFolders[]="/cs148/cs148-master/assignment10.0";
    $whiteListFolders[]="/cs148develop/assignment10.0";
    $whiteListFolders[]="/cs148/assignment10.0";
    $whiteListFolders[] = "/education/cs148/assignment10.0";
    $whiteListFolders[] = "/develop/cs148/assignment10.0";
